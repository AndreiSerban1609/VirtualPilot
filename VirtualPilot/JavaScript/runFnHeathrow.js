function runFnHeathrow(){
    if (ok){
        ...
        if (currentSpeed > 140){
            ...
            HeathrowCenter = new google.maps.LatLng(currentLat, currentLong);
            marker.setPosition(HeathrowCenter);
            var icon = marker.getIcon();
            icon.rotation = Heading;
            marker.setIcon(icon);
            HeathrowMap.panTo(HeathrowCenter);
            HeathrowMap.setCenter(HeathrowCenter);
